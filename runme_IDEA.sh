...
#export SETTING_GIT_HOME="/Users/yara/settings/IntellijIDEA/config"
#ln -s /common/Google\ Drive/settings/IntellijIDEA/config/codestyles/ codestyles

ln -s "$SETTING_GIT_HOME/codestyles" codestyles
ln -s "$SETTING_GIT_HOME/colors" colors
ln -s "$SETTING_GIT_HOME/keymaps" keymaps
