...
BASH_ENV=.bashrc
H8="/C/Dev8"
alias git-all="get-git $H8/xbm-idd;get-git $H8/xbm-domain;get-git $H8/xbm-framework;get-git $H8/xbm-database;get-git $H8/xbm-readers;get-git $H8/xbm;get-git $H8/xbm-test-framework;get-git $H8/xbm-integration-tests"
...
alias tests8="java8;mvn-it $H8/xbm-test-framework;mvn-it $H8/xbm-integraion-tests -DskipTests;"
alias wrk="cd $H8"
