...
( global-set-key (kbd "s-1") (lambda() (interactive) (activate-input-method nil)))
( global-set-key (kbd "s-2") (lambda() (interactive) (activate-input-method 'russian-computer)))
( global-set-key (kbd "s-3") (lambda() (interactive) (activate-input-method 'ukrainian-computer)))
( provide 'encodings)
