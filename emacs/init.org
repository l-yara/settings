   ...
   (let* ((package--builtins nil)
          (packages
           '(auto-compile         ; automatically compile Emacs Lisp libraries
             ...
             goto-last-change ; Go to last change
             ...
             move-text ; Move text up and down
...
** Flyspell
   ...
   (defadvice turn-on-flyspell (before check nil activate)
     ...
     (when (executable-find ispell-program-name)
       (local-se t-key (kbd "C-c l") (cycle-languages))))
   #+END_SRC
...
** Bindings for functions defined [[sec:defuns][above]].
   ...
   (define-key custom-bindings-map (kbd "s-y")     'kill-whole-line)
   (define-key custom-bindings-map (kbd "s-q")     'goto-last-change)
   (define-key custom-bindings-map (kbd "<s-S-up>")  'move-text-up)
   (define-key custom-bindings-map (kbd "<s-S-down>") 'move-text-down)
   (define-key custom-bindings-map (kbd "C-c 1")   'toggle-shell)
